...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x191e5, (ISR)0x263e7}, /* 42 */
	...
	{(const void *)0x190e5, (ISR)0x263e7}, /* 49 */
